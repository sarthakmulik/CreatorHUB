    ...
    <div style={{
          ...
          {imageUrl && (
            <img 
              ...
              style={{ 
                ...
                filter: `brightness(${filters.brightness}%) contrast(${filters.contrast}%) saturate(${filters.saturation}%) blur(${filters.blur}px) sepia(${filters.sepia}%) hue-rotate(${filters.hue}deg)`,
      ...
      {!isExporting && (
        <div style={{
          ...
          {activeTab === "emoji" && selectedNode && (selectedNode.type === "emoji" || selectedNode.type === "image") && (
            <div style={{ background: "rgba(30,30,30,0.8)", backdropFilter: "blur(20px)", borderRadius: "20px", padding: "16px", display: "flex", flexDirection: "column", gap: 16, animation: "slide-up 0.3s ease" }}>
